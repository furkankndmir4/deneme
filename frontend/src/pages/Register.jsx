    ...
    <div className="flex flex-col items-center justify-center min-h-screen py-12 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="glass-panel p-8">
          <h2 className="text-2xl font-bold text-center mb-6 text-gray-200">Hesap Oluşturun</h2>
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            <div>
              <label className="block text-gray-300 mb-2 text-sm" htmlFor="email">E-posta</label>
              <input
                id="email"
                type="email"
            ...
            <div>
              <label className="block text-gray-300 mb-2 text-sm" htmlFor="password">Şifre</label>
              <input
                id="password"
                type="password"
                className="glass-input w-full p-3"
            ...
            <div>
              <label className="block text-gray-300 mb-2 text-sm" htmlFor="confirmPassword">Şifre Tekrarı</label>
              <input
                id="confirmPassword"
                type="password"
                className="glass-input w-full p-3"
            ...
            <div>
              <label className="block text-gray-300 mb-2 text-sm">Kullanıcı Tipi</label>
              <div className="flex space-x-4">
                <div className="flex items-center">
                  ...
                  />
                  <label htmlFor="athlete" className="ml-2 text-sm text-gray-300">Sporcu</label>
                </div>
                <div className="flex items-center">
                  <input 
                    id="coach" 
                    ...
                    onChange={(e) => setUserType(e.target.value)}
                  />
                  <label htmlFor="coach" className="ml-2 text-sm text-gray-300">Antrenör</label>
                </div>
              </div>
            </div>
            <button
